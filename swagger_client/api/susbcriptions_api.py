...
class SusbcriptionsApi(object):
    ...
    def execute_subscription(self, paycomet_api_token, order, **kwargs):  # noqa: E501
        """Excute a susbcription payment.  # noqa: E501

        This command excecutes a payment of the subscription. This payment does not affect the rest of the subscription payments. However, as it doesn´t belongs to the recurrency it may be denied if the amount is different or even just because of the date of execution as it is not the expected by the bank.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.execute_subscription(paycomet_api_token, order, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str paycomet_api_token: PAYCOMET API key (Authorization privilege required) (required)
        :param str order: (required)
        :param OrderExecuteBody body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.execute_subscription_with_http_info(paycomet_api_token, order, **kwargs)  # noqa: E501
        else:
            (data) = self.execute_subscription_with_http_info(paycomet_api_token, order, **kwargs)  # noqa: E501
            return data

    def execute_subscription_with_http_info(self, paycomet_api_token, order, **kwargs):  # noqa: E501
        """Excute a susbcription payment.  # noqa: E501

        This command excecutes a payment of the subscription. This payment does not affect the rest of the subscription payments. However, as it doesn´t belongs to the recurrency it may be denied if the amount is different or even just because of the date of execution as it is not the expected by the bank.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.execute_subscription_with_http_info(paycomet_api_token, order, async_req=True)
        >>> result = thread.get()
        ...
        if ('paycomet_api_token' not in params or
                params['paycomet_api_token'] is None):
            raise ValueError("Missing the required parameter `paycomet_api_token` when calling `execute_subscription`")  # noqa: E501
        # verify the required parameter 'order' is set
        if ('order' not in params or
                params['order'] is None):
            raise ValueError("Missing the required parameter `order` when calling `execute_subscription`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/subscription/{order}/execute', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
