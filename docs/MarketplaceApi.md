...
# **split_transfer**
> InlineResponse20025 split_transfer(paycomet_api_token, body=body)
...
> InlineResponse20025 split_transfer_reversal(paycomet_api_token, body=body)
...
# **transfer**
> InlineResponse20026 transfer(paycomet_api_token, body=body)
...
# **transfer_reversal**
> InlineResponse20026 transfer_reversal(paycomet_api_token, body=body)
